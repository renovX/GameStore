        ...
        <div id="carouselExampleCaptions" className="carousel slide">
          ...
          <div className="carousel-inner" id="home">
            <div className="carousel-item active akka">
              <div className="showimg"><img src={require("../images/spiderman.jpg")} className="carousal-img" alt="..." /></div>
            ...
            <div className="carousel-item akka">
              <div className="showimg"><img src={require("../images/valorant.jpg")} className="carousal-img" alt="..." /></div>
              <div className="carousel-caption d-none d-md-block">
                <h1 className="showmess">BLUESTAR INTERACTIVE</h1>
            ...
            <div className="carousel-item akka">
              <div className="showimg"><img src={require("../images/pubg3.jpg")} className="carousal-img" alt="..." /></div>
              <div className="carousel-caption d-none d-md-block">
                <h1 className="showmess">BLUESTAR INTERACTIVE</h1>
