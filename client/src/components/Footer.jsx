...
function Footer() {
    return (
        <footer style={{ backgroundColor: 'rgb(70, 0, 0)', bottom: 0, width: '100%' }} id="contact">
            <div className="container">
                <div className="row">
                    <div className="col-md-12">
                        <p style={{ textAlign: 'center', color: 'white', marginTop: '2rem', fontSize: '1.2rem' }}>Developed by Basit Shaikh</p>
